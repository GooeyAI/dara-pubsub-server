...
$root.WsClientMsg = (function () {
  ...
  WsClientMsg.fromObject = function fromObject(object) {
    if (object instanceof $root.WsClientMsg) return object;
    var message = new $root.WsClientMsg();
    if (object.authToken != null) message.authToken = String(object.authToken);
    return message;
  };
  ...
  WsClientMsg.toObject = function toObject(message, options) {
    if (!options) options = {};
    var object = {};
    if (options.defaults) object.authToken = "";
    if (message.authToken != null && message.hasOwnProperty("authToken"))
...
$root.WsServerMsg = (function () {
  ...
  WsServerMsg.fromObject = function fromObject(object) {
    if (object instanceof $root.WsServerMsg) return object;
...
$root.PubsubMsg = (function () {
   ...
   * @property {string|null} [senderPlatform] PubsubMsg senderPlatform
   */
   ...
   * @member {string} msgPropsJson
   * @memberof PubsubMsg
   * @instance
   */
  PubsubMsg.prototype.msgPropsJson = "";

  /**
   * PubsubMsg senderPlatform.
   * @member {string} senderPlatform
   * @memberof PubsubMsg
   * @instance
   */
  PubsubMsg.prototype.senderPlatform = "";
  ...
  PubsubMsg.encode = function encode(message, writer) {
    ...
    if (message.data != null && Object.hasOwnProperty.call(message, "data"))
      writer.uint32(/* id 2, wireType 2 =*/ 18).bytes(message.data);
    if (
      message.msgPropsJson != null &&
      Object.hasOwnProperty.call(message, "msgPropsJson")
    )
    ...
    if (
      ...
      writer.uint32(/* id 4, wireType 2 =*/ 34).string(message.senderPlatform);
    return writer;
  };
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.senderPlatform = reader.string();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  PubsubMsg.verify = function verify(message) {
    ...
    if (
      ...
      if (!$util.isString(message.senderPlatform))
        return "senderPlatform: string expected";
    return null;
  };
  ...
  PubsubMsg.fromObject = function fromObject(object) {
    if (object instanceof $root.PubsubMsg) return object;
    ...
    if (object.senderPlatform != null)
      message.senderPlatform = String(object.senderPlatform);
    return message;
  };
  ...
  PubsubMsg.toObject = function toObject(message, options) {
    ...
    if (
      ...
      object.senderPlatform = message.senderPlatform;
    return object;
  };
